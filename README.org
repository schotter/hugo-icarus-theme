The original Hugo Icarus theme has been unmaintained for years, and as Hugo upgraded, some features broke (such as recent posts, and post counts). This version fixes some of these. 
