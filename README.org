The original Hugo Icarus theme has been unmaintained for years, and as Hugo upgraded, some features broke (such as front-page post listin, recent posts, and post counts). This version fixes such issues. 
